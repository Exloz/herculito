    ...
    >
      <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
          <button type="button" onClick={onToggleAllUsers} className="btn-secondary text-sm">
            {areAllUsersExpanded ? 'Colapsar todos' : 'Expandir todos'}
          </button>
          <select value={userSort} onChange={(event) => onUserSortChange(event.target.value as AdminUserSort)} className="input input-sm bg-white/[0.03] text-sm sm:w-auto">
